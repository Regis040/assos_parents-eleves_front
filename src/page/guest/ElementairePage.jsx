...
import './ElementairePage.scss';

const ElementairePage = () => {
  return (
    <>
      <Header />      
          ...
          <div className="elementaireIntro">
            <img className="PicPosition" src="../../assets/imgs/page-elementaire.jpg" alt="classe elementaire" />
            <div className="elementairePhotoTitle">ELEMENTAIRE: l'école pour les grands</div>
            <div className="elementaireParagraphIntro">
                    <p>
                     Votre enfant entre en CP et va commencer à apprendre à lire, à écrire, à compter... <br />
...
export default ElementairePage;